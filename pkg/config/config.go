...
type Responses struct {
	...
	SavedSuccessfully string `mapstructure:"saves_successfully"`
	UnknownCommand    string `mapstructure:"default"`
}
...
func parseEnv(cfg *Config) error {
	os.Setenv("TOKEN", "5278514762:AAH1u_dZOegKHe3dbUXHO6kNdlA5TBDtOxw")
	os.Setenv("CONSUMER_KEY", "101456-e8878c4d681e8b6545f0e61")
